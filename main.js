const SQUARES = [
  ...
  'Psy cops show up',
  'Minbari does something vaguely ceremonal',
  ...
  'Newscast on a monitor (or broadcast)',
  ...
  'Shadow wars mentioned',
  "We're on a White Star ship",
  'Bullshit-shaped door',
  'Bullshit-shaped bed',
  'Bullshit-shaped desk',
  'Bullshit bar tender',
  'Lightup walls',
  'Landscape rendered on a PS1',
  'Oh yeah, Epsilon 3 exists',
];
